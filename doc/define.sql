...
CREATE TABLE IF NOT EXISTS `mall`.`order` (
    ...
    `reward_record_id` bigint(20) NULL DEFAULT NULL COMMENT '积分记录id',
...
CREATE TABLE IF NOT EXISTS `mall`.`shop` (
    ...
    `name` varchar(64) NOT NULL COMMENT '商家名',
...
INSERT INTO `shop` VALUES (10,'永和大王','北京市朝阳区',10,'OPEN','2022-01-01 00:00:00','2022-01-01 00:00:00');
INSERT INTO `goods` VALUES (10,'馄饨',30.00,10,'AVAILABLE','2022-01-01 00:00:00','2022-01-01 00:00:00');